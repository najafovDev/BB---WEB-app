...
class Banners extends Translatable
{
	...
	public function rules()
	{
        ...
        public function types($key=NULL){
            $tmp= array(
                'slider'=>Yii::t('frontend.strings','Slider Banners'),
                'seo-banners'=>Yii::t('frontend.strings','Seo Banners'),
                'bottom-banners'=>Yii::t('frontend.strings','Bottom Banners'),
            );
            if ($key)
	...
	public static function model($className=__CLASS__)
	{
        ...
        public function getImageUrl($path=null){
            $str = '/uploads/banners/'.$this->pic_name;
            if ($path){
                $str = "/site/uploads/banners/$path/{$this->pic_name}";
            }
            return $str;
        }
}
