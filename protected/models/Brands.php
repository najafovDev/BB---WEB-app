...
class Brands extends Translatable
{
    ...
    public function rules()
    {
        ...
        return array(
            array('name,logo,logo_dark','required'),
            array('name, logo, logo_dark', 'length', 'max'=>255),
    ...
    public function relations()
    {
        ...
        return array(
            ...
            'itemsCount'=>array(self::STAT,'Items','brands_id'),
            'cleanurls'=>array(self::HAS_MANY,'Cleanurls','parent_id','condition'=>'cleanurls.type="Brands"'),
        );
    }
