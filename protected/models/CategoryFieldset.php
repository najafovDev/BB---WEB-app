...
class CategoryFieldset extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			...
			'usageCount' => array(self::STAT, 'CategoryFieldsetRelation', 'fieldset_id'),
                        'value'=>array(self::HAS_MANY,'ItemsParamset','fieldset_id','index'=>'items_id','together'=>true,'condition'=>'value.language='.Yii::app()->db->quoteValue(Yii::app()->controller->Lang)),
		);
	}
	...
	public function attributeLabels()
	{
        ...
        public function getListData(){
            return array('text'=>'text','integer'=>'integer','array'=>'array','bool'=>'bool');
        }
	/**
