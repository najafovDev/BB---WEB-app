...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('artikul')); ?>:</b>
	<?php echo CHtml::encode($data->artikul); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('artikul2')); ?>:</b>
	<?php echo CHtml::encode($data->artikul2); ?>
	<br />
