...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('sername')); ?>:</b>
	<?php echo CHtml::encode($data->sername); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('nicname')); ?>:</b>
	<?php echo CHtml::encode($data->nicname); ?>
	<br />
