...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'sername'); ?>
		<?php echo $form->textField($model,'sername',array('size'=>60,'maxlength'=>255)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'nicname'); ?>
		<?php echo $form->textField($model,'nicname',array('size'=>60,'maxlength'=>255)); ?>
	</div>
