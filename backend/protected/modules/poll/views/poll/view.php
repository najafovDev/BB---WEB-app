...
<h1><?php echo CHtml::encode($model->title_en); ?></h1>

<?php if ($model->description_en): ?>
<p class="description"><?php echo CHtml::encode($model->description_en); ?></p>
<?php endif; ?>
...
<?php if ($userVote->id): ?>
  <p id="pollvote-<?php echo $userVote->id ?>">
    You voted: <strong><?php echo $userChoice->label_en ?></strong>.<br />
    <?php
      if ($userCanCancel) {
        echo CHtml::ajaxLink(
          'Cancel Vote',
