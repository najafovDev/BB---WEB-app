<tr id="pollchoice-<?php echo $id ?>">
  ...
  <td class="label">
    <?php echo CHtml::activeTextField($choice,"[$id]label_en",array('size'=>60,'maxlength'=>255)); ?>
    <?php echo CHtml::error($choice,"[$id]label_en"); ?>
    <div class="errorMessage" style="display:none">You must enter a label.</div>
  </td>
  <td class="label">
    <?php echo CHtml::activeTextField($choice,"[$id]label_az",array('size'=>60,'maxlength'=>255)); ?>
    <?php echo CHtml::error($choice,"[$id]label_az"); ?>
    <div class="errorMessage" style="display:none">You must enter a label.</div>
  </td>
  <td class="actions">
  <?php
