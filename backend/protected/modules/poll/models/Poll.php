...
class Poll extends CActiveRecord
{
  ...
  {
    return array(
      array('title_az,title_en', 'required'),
      array('status', 'numerical', 'integerOnly'=>true),
      array('title_en,title_az', 'length', 'max'=>255),
      array('description_az,description_en', 'safe'),
      array('title_en,title_az, description, status', 'safe', 'on'=>'search'),
    );
  }
  ...
  public function search()
  {
    ...
    $criteria->compare('description_az',$this->description_az,true);
