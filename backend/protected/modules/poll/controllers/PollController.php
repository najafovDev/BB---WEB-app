<?php
Yii::import('application.controllers.ProductsTranslateController');

class PollController extends ProductsTranslateController
{
  /**
  ...
  public function actionVote($id)
  {
    ...
    foreach ($model->choices as $choice) {
      $choices[$choice->id] = CHtml::encode($choice->label_en);
    }
